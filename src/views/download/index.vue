    ...
    <div class="download-container">
        ...
        <div class="download-btn">
            ...
            <r-button width="64%"
                      ...
                      class="d-btn" @comfirm="clickURL(android || 'http://rcposs.oss-accelerate.aliyuncs.com/adr/ADR.v.1.0.4.apk')" />
            <!--<r-button width="64%"
                      bgColor="$active"
                      text="登录WEB版本"
                      icon="download_web"
        ...
        <div class="download-qrcode">
            <rQrcode qrcodeUrl="https://www.adrchain.org/dist/index.html#/download"/>
        </div>
    </div>
</template>
<script>
    export default {
        ...
        methods : {
            ...
            downloadApp (){
                location.href = this.android || 'http://rcposs.oss-accelerate.aliyuncs.com/adr/ADR.v.1.0.0.apk';
            }
        }
    }
</script>
