<template>
    <section class="zhuanqian">
        <Header :title="'ADS ' + $t(`lang80`) + ' USDT'"></Header>
        ...
        <div class="box2">
            ...
            <div class="l">≈ {{(code || 0) * 0.999}} USDT； * {{`${$t(`wallet.can`)}：${decimal(coinBalances || 0).toFixed(6) * 1} ADS`}}</div>
        </div>
...
<script>
    export default {
        ...
        methods: {
            updateBalances (){
                this.coinBalances = this.balancesBTC.value || 0;
            },
            codeVerify (){
                ...
                this.account.verifyPassword(password).then(async () => {
                    ...
                    let option = {
                        ...
                        totalPrice:  {
                            ...
                            value : (this.code * 0.999).toString(),
                        }
                    };
                    this.rcp
